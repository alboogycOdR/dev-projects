...
void OnStart()
  {
   ...
   printHelper(LOG_INFO, StringFormat("Script: About to execute sell limit on %s with spread %d ", _Symbol, spread));
   ...
   placeSellLimit(m_trade, price, 0.00, 0.00, FIXED_DEAL_AMOUNT, "[M] ");
  }
