   ...
   if(OrdersTotal() ==0 && PositionsTotal() == 0 && isNewCandle1M() == true)
     {
      ...
      if(C_star() == "BUY")
        ...
        SL = NormalizeDouble(TOP,_Digits);
         ...
         bool CSTARBUY = trade.Buy(Volume
                                   ,Symbol()
                                   ,ask,
                                  NULL,
                                   TOP-poits*_Point
      ...
      if(diraction =="SELL")
        {
         ...
         //   bool orderBuy = trade.BuyLimit(Volume,Bid,NULL,
         //SL,
         //TOP-poits*_Point
         //,0,0,NULL);
         //  }
...
//SIGNALS
   if(iLow(_Symbol,_Period,1) == newLow && isNewCandle1M()==true && PositionsTotal()== 0)
      diraction = "BUY";
   if(iHigh(_Symbol,_Period,1) == newHigh && isNewCandle1M()==true&& PositionsTotal()== 0)
      diraction = "SELL";
