...
//+------------------------------------------------------------------+
#property copyright "Copyright 2021, alisterFX"
#property description   "Automatic SL/TP/Trail"
...
input bool   inpEnableTest=true;//Enable Test on Strategy Tester
...
bool                  RUNMODE_EXPIRY=false;    //Enable expiry
datetime              expiryDate = D'2023.07.31 17:00'; //change as per your requirement
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
