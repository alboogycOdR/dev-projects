...
input string CalendarCacheFile = "NEWSDATA.cal";
      ...
      if(!MQLInfoInteger(MQL_TESTER)) /*LIVE or DEMO*/
        {
         ...
         fptr = new CalendarFilter();   Print(__LINE__);

        }
      else    /*TESTER*/
        {
         Print("Can't proceed in the tester without calendar cache file");   Print(__LINE__);
