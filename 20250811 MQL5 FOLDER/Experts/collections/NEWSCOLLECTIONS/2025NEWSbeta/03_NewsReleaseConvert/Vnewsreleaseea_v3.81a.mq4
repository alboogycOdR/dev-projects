//====================================================================================================================================================//
#property copyright   "Copyright 2015-2020, Nikolaos Pantzos"
...
#property description "Add URL 'http://cdn-nfs.faireconomy.media/ff_calendar_thisweek.xml' to the list of allowed URLs in the Expert Advisors tab of the Options window (Tools>Options>Expert Advisors)."
#property description "To better illustrate of graphics, select sreen resolution 1280x1024."
//#property icon        "\\Images\\NewsRelease_Logo.ico";
#property strict

/*

NewsReleaseEA (Multipair financial/economic news release strategy): https://www.mql5.com/en/code/26352
...
extern string ReadNewsURL               = "http://cdn-nfs.faireconomy.media/ff_calendar_thisweek.xml";//URL To Get News
...
//Reset buffers
   ...
   ExtBufferImpact[CountrySelect][0]=0;
   ExtBufferImpact[CountrySelect][1]=0;
//---------------------------------------------------------------------
//Set buffers
   for(i=0; i<NewsIDx; i++)
     {
