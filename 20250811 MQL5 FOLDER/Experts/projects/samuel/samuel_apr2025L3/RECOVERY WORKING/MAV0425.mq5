...
input double   BreakevenThreshold = -10.0;    // Max loss for pair to be considered breakeven (no recovery)
input int      BreakevenSLTolerancePoints = 100; // Tolerance in points for SL considered at breakeven
...
input color  PositionLabelColor    = clrDodgerBlue;     // Label Color
