...
int OnInit()
{
   ...
   trade.SetTypeFillingBySymbol(_Symbol); // Set filling mode based on symbol
   //--- Set timer
...
void ProcessSignal(const SignalData &signal)
{
   ...
   g_digits = (int)SymbolInfoInteger(brokerSymbol, SYMBOL_DIGITS);
   g_point = SymbolInfoDouble(brokerSymbol, SYMBOL_POINT);
