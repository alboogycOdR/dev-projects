...
//+------------------------------------------------------------------+
// v1.2: History mode added. Set "historyMode" parameter to true then "double click" on any point in price chart to see 
//       Support and Resistance zones in that point.
...
input bool              SetGlobals=true;                 // Set terminal global variables
...
input color             Text_color = clrWhiteSmoke;           // Text Color
