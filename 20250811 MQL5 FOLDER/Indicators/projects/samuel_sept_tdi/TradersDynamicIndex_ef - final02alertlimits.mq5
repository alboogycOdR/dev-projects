...
//Print("currentValue : "+currentValue);
   for(int i = 0; i < ArraySize(levels); i++) {
      if(currentValue == NormalizeDouble(levels[i],1)) {
         // Level matched
         string alertMessage = "MARKET_BASE_LINE touch " + DoubleToString(levels[i], 1) +
                               " on " + _Symbol + "("+PeriodToString(Period())+")" +
                               " at " + TimeToString(TimeCurrent(), TIME_MINUTES);
...
//Print(TimeCurrent());
   ...
   for(int i = 0; i < ArraySize(levels); i++) {
      if(currentValue == NormalizeDouble(levels[i],1)) {
         // Level matched
         string alertMessage = "RSI_PRICE_LINE touch " + DoubleToString(levels[i], 1) +
                               " on " + _Symbol + "("+PeriodToString(Period())+")" +
                               " at " + TimeToString(TimeCurrent(), TIME_MINUTES);
...
// Too few bars to work with.
   ...
   if(EnableCrossingOfMBL) CROSSING_OF_MBL_EQUAL();
//=======================================================
   if(EnableCrossingOfRSI_PRICE_LINE) CROSSING_OF_RSI_PRICE_LINE_EQUAL();
//=======================================================
//removed
// if(isCrash) {
