...
public:
   ...
   {      
      ...
      double points   = SymbolInfoDouble(_symbol,SYMBOL_POINT);//MarketInfo(_symbol, MODE_POINT);
      long digits   = SymbolInfoInteger(_symbol,SYMBOL_DIGITS);//  MarketInfo(_symbol, MODE_DIGITS);
