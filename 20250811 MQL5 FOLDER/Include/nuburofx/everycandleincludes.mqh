...
input group "Support and Resistence Zones"

//input bool suppdemandhide = true;//Hide Support Resistence from chart
//input ENUM_TIMEFRAMES Timeframe  = PERIOD_H1;   //SupplyDemand Zones Timeframe
//ENUM_TIMEFRAMES timeframeglobal;
