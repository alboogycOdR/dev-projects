...
//| Parameter=PeriodMA,int,13, Period of MA                          |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
class CBC_WS_MFI : public CCandlePattern
  {
protected:
   CiMFI               m_MFI;            // object-MFI
   //--- adjusted parameters
   int                 m_periodMFI;      // the "period of calculation" parameter of the oscillator
   ENUM_APPLIED_VOLUME m_applied;        // the "volumes" parameter of the oscillator
...
//+------------------------------------------------------------------+
//| Constructor CBC_WS_MFI.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CBC_WS_MFI::CBC_WS_MFI()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_MFI::ValidationSettings()
  {
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_MFI::InitIndicators(CIndicators *indicators)
  {
//--- check pointer
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CBC_WS_MFI::InitMFI(CIndicators *indicators)
  {
//--- check pointer
   if(indicators==NULL) return(false);
...
int CBC_WS_MFI::LongCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of 3 White Soldiers and MFI<40
...
int CBC_WS_MFI::ShortCondition()
  {
   int result=0;
   int idx   =StartIndex();
//--- check formation of 3 Black Crows pattern and MFI>60
