...
// Open position
bool CTradeBook::OpenPosition(string pSymbol, ENUM_ORDER_TYPE pType, double pVolume, double pStop = 0, double pProfit = 0, string pComment = NULL)
{
	ZeroMemory(request);
	ZeroMemory(result);
...
// Open pending order
bool CTradeBook::OpenPending(string pSymbol,ENUM_ORDER_TYPE pType,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,double pStopLimit = 0,datetime pExpiration=0,string pComment=NULL)
{
	ZeroMemory(request);
	ZeroMemory(result);
...
// Modify position
bool CTradeBook::ModifyPosition(string pSymbol,double pStop,double pProfit=0.000000)
{
	ZeroMemory(request);
	ZeroMemory(result);
...
bool CTradeBook::ModifyPending(ulong pTicket,double pPrice,double pStop,double pProfit,datetime pExpiration=0)
{
	ZeroMemory(request);
	ZeroMemory(result);
...
// Close position
bool CTradeBook::Close(string pSymbol,double pVolume=0.000000,string pComment=NULL)
{
	ZeroMemory(request);
	ZeroMemory(result);
...
bool CTradeBook::Delete(ulong pTicket)
{
	ZeroMemory(request);
	ZeroMemory(result);
...
void CTradeBook::LogTradeRequest()
{
...
bool CTradeBook::Buy(string pSymbol,double pVolume,double pStop=0.000000,double pProfit=0.000000,string pComment=NULL)
{
	bool success = OpenPosition(pSymbol,ORDER_TYPE_BUY,pVolume,pStop,pProfit,pComment);
	return(success);
}

bool CTradeBook::Sell(string pSymbol,double pVolume,double pStop=0.000000,double pProfit=0.000000,string pComment=NULL)
{
	bool success = OpenPosition(pSymbol,ORDER_TYPE_SELL,pVolume,pStop,pProfit,pComment);
	return(success);
}

bool CTradeBook::BuyLimit(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
{
	bool success = OpenPending(pSymbol,ORDER_TYPE_BUY_LIMIT,pVolume,pPrice,pStop,pProfit,0,pExpiration,pComment);
	return(success);
}

bool CTradeBook::SellLimit(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
{
	bool success = OpenPending(pSymbol,ORDER_TYPE_SELL_LIMIT,pVolume,pPrice,pStop,pProfit,0,pExpiration,pComment);
	return(success);
}

bool CTradeBook::BuyStop(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
{
	bool success = OpenPending(pSymbol,ORDER_TYPE_BUY_STOP,pVolume,pPrice,pStop,pProfit,0,pExpiration,pComment);
	return(success);
}

bool CTradeBook::SellStop(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
{
	bool success = OpenPending(pSymbol,ORDER_TYPE_SELL_STOP,pVolume,pPrice,pStop,pProfit,0,pExpiration,pComment);
	return(success);
}

bool CTradeBook::BuyStopLimit(string pSymbol,double pVolume,double pPrice,double pStopLimit,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
{
	bool success = OpenPending(pSymbol,ORDER_TYPE_BUY_STOP_LIMIT,pVolume,pPrice,pStop,pProfit,pStopLimit,pExpiration,pComment);
	return(success);
}

bool CTradeBook::SellStopLimit(string pSymbol,double pVolume,double pPrice,double pStopLimit,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
{
...
// Set magic number
void CTradeBook::MagicNumber(ulong pMagic)
{
	magicNumber = pMagic;
}
...
// Set deviation
void CTradeBook::Deviation(ulong pDeviation)
{
...
// Set fill type
void CTradeBook::FillType(ENUM_ORDER_TYPE_FILLING pFill)
{
	fillType = pFill;
}
