...
// Inputs.
INPUT_GROUP("Momentum strategy: main");
...
// Includes strategy.
#include "Stg_Momentum.mqh"

// Defines.
#define ea_name "Strategy Momentum"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Momentum"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Momentum>(Active_Tfs);
