...
- **Type**: Indicator
- **Path**: `tradingview/Institutional CRT Framework/institutional_crt_frameworkv2.pine`
...
- **Plots**:
  - plotchar: 2C Bull Flag
  - plotchar: 2C Bear Flag
...
- **Alerts**:
  ...
  - 3C Bull Detected
  - 3C Bear Detected
  - Inside Bull Detected
  - Inside Bear Detected
  - Outside Detected
...
### Example
```text
Add '2C Bull Detected' to the chart and enable relevant inputs.
