## NY SMC Suite Multi-Killzone (Protected)

- **Type**: Indicator
- **Path**: `tradingview/PROJECT 714/secured_variation/blueprint/Protected_Indicator.pine`
...
- **Plots**:
  - plotshape: Upper Wick Rejection
  - plotshape: Lower Wick Rejection
...
### Example
```text
Add 'NY SMC Suite Multi-Killzone (Protected)' to the chart and enable relevant inputs.
