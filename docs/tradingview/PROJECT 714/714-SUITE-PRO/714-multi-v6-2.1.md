## NY SMC Suite Pro v2.1

- **Type**: Indicator
- **Path**: `tradingview/PROJECT 714/714-SUITE-PRO/714-multi-v6-2.1.pine`
...
### Example
```text
Add 'NY SMC Suite Pro v2.1' to the chart and enable relevant inputs.
