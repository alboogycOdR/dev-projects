...
- **Type**: Indicator
- **Path**: `tradingview/PROJECT 714/714-SUITE-PRO/714-multi-v7-2.2.pine`
...
### Example
```text
Add 'NY SMC Suite Pro v2.2' to the chart and enable relevant inputs.
