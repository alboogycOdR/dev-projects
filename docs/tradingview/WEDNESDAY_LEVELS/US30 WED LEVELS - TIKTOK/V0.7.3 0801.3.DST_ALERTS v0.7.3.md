## WED & MIDNIGHT DST System v0.7.3 (Alerts + Optimization)

- **Type**: Indicator
- **Path**: `tradingview/WEDNESDAY_LEVELS/US30 WED LEVELS - TIKTOK/V0.7.3 0801.3.DST_ALERTS v0.7.3.pine`
...
### Example
```text
Add 'WED & MIDNIGHT DST System v0.7.3 (Alerts + Optimization)' to the chart and enable relevant inputs.
