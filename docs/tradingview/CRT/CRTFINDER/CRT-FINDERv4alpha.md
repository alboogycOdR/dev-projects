## Complete CRT System (MTF v5alpha)

- **Type**: Indicator
- **Path**: `tradingview/CRT/CRTFINDER/CRT-FINDERv4alpha.pine`
...
### Example
```text
Add 'Complete CRT System (MTF v5alpha)' to the chart and enable relevant inputs.
