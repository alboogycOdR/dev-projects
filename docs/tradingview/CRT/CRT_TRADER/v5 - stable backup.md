## Dual-Mode CRT Levels (Corrected)v5

- **Type**: Indicator
- **Path**: `tradingview/CRT/CRT_TRADER/v5 - stable backup.pine`
...
- **Plots**:
  - plot: CRT High
  - plot: CRT Low
  - plotchar: Target Candle Found
  - plotchar: New Day Start
...
### Example
```text
Add 'Dual-Mode CRT Levels (Corrected)v5' to the chart and enable relevant inputs.
