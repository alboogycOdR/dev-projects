## Institutional CRT Engine v3.2 - Final

- **Type**: Indicator
- **Path**: `tradingview/CRT/CRT-ENGINE-PROJECT/CRT_ENGINE/CRT-ENGINE-DUALv3.2.pine`
...
### Example
```text
Add 'Institutional CRT Engine v3.2 - Final' to the chart and enable relevant inputs.
