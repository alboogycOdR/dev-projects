...
- **Type**: Indicator
- **Path**: `tradingview/CRT/CRT-ENGINE-PROJECT/CRT_ENGINE/CRT-ENGINE.pine`
...
### Example
```text
Add 'Institutional CRT Engine v3.0' to the chart and enable relevant inputs.
