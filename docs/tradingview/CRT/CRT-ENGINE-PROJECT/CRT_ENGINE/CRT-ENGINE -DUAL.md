## Institutional CRT Engine v3.0 - Dual Mode

- **Type**: Indicator
- **Path**: `tradingview/CRT/CRT-ENGINE-PROJECT/CRT_ENGINE/CRT-ENGINE -DUAL.pine`
...
### Example
```text
Add 'Institutional CRT Engine v3.0 - Dual Mode' to the chart and enable relevant inputs.
