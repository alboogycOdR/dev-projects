## Institutional CRT Engine v5.0 – Fixed

- **Type**: Indicator
- **Path**: `tradingview/CRT/CRT-ENGINE-PROJECT/CRT-ENGINE-MANUS-PINE/CRT_Engine_v5.1.pine`
...
### Example
```text
Add 'Institutional CRT Engine v5.0 – Fixed' to the chart and enable relevant inputs.
