## CRT Bias Scanner v3.4 Optimized

- **Type**: Indicator
- **Path**: `tradingview/CRT/CRT Bias Scanner/CRT Bias Scanner v3.4 Optimized.pine`
...
### Example
```text
Add 'CRT Bias Scanner v3.4 Optimized' to the chart and enable relevant inputs.
