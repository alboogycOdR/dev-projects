...
input string TimeLineStart="1900";                    //Start Time To Draw (Format 24H HHMM)
input string TimeLineEnd="2000";                          //End Time To Draw (Optional - Format HHMM)
...
input int BarsToScan=40000;                               //Maximum Bars To Search (0=No Limit)

input string Comment_3="====================";        //Objects Options
input color LineColor=clrGreenYellow;                   //Objects Color
...
void DrawArea(datetime Start, datetime End){
   string AreaName=IndicatorName+"-AREA-"+(string)TimeCurrent()+IntegerToString(Start);
