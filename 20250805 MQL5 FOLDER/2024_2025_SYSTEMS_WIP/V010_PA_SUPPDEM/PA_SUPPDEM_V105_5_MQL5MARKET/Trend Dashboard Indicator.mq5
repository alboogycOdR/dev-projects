...
#property copyright "Tradingforliving.my.id, 2010-2023"
#property link      "https://Tradingforliving.my.id"
#property version   "1.02"

#property description "Trend Dashboard - an indicator that shows simple trade recommendations based on the Stochastic, RSI, and CCI readings."
...
string ShortName = "Trend Dashboard";
