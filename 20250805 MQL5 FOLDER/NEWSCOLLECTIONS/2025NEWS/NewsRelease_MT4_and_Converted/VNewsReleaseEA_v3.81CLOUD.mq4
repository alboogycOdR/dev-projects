...
#property description "Add URL 'http://nfs.faireconomy.media/ff_calendar_thisweek.xml' to the list of allowed URLs in the Expert Advisors tab of the Options window (Tools>Options>Expert Advisors)."
...
extern string ReadNewsURL               = "http://nfs.faireconomy.media/ff_calendar_thisweek.xml";//URL To Get News
