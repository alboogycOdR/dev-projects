...
#property copyright     "nuburo trading solutions - 2019-2023"
...
input string ExpertName = "expert_atr_stop";          // Expert Name (to name the objects)
...
datetime              expiryDate = D'2023.08.18 17:00'; //change as per your requirement
...
void DrawPanel()
  {
   string PanelText = "ATR_TRAILING_STOP";
   string PanelToolTip = "ATR Trailing Stop-Loss";
