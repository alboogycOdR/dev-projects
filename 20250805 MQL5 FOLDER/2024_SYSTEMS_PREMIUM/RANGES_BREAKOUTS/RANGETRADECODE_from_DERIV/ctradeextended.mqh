...
//+------------------------------------------------------------------+
//| CTradeBook Class - Open, Close and Modify Orders                                                           |
//+------------------------------------------------------------------+
...
// Open position
bool CTradeExtended::OpenPosition(string pSymbol, ENUM_ORDER_TYPE pType, double pVolume, double pStop = 0, double pProfit = 0, string pComment = NULL)
  {
   ZeroMemory(request);
   ZeroMemory(result);
...
// Open pending order
bool CTradeExtended::OpenPending(string pSymbol,ENUM_ORDER_TYPE pType,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,double pStopLimit = 0,datetime pExpiration=0,string pComment=NULL)
  {
   ZeroMemory(request);
   ZeroMemory(result);
...
// Modify position
bool CTradeExtended::ModifyPosition(string pSymbol,double pStop,double pProfit=0.000000)
  {
   ZeroMemory(request);
   ZeroMemory(result);
...
bool CTradeExtended::ModifyPending(ulong pTicket,double pPrice,double pStop,double pProfit,datetime pExpiration=0)
  {
   ZeroMemory(request);
   ZeroMemory(result);
...
// Close position
bool CTradeExtended::Close(string pSymbol,double pVolume=0.000000,string pComment=NULL)
  {
   ZeroMemory(request);
   ZeroMemory(result);
...
bool CTradeExtended::Delete(ulong pTicket)
  {
   ZeroMemory(request);
   ZeroMemory(result);
...
//|                                                                  |
//+------------------------------------------------------------------+
void CTradeExtended::LogTradeRequest()
  {
...
bool CTradeExtended::Buy(string pSymbol,double pVolume,double pStop=0.000000,double pProfit=0.000000,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::Sell(string pSymbol,double pVolume,double pStop=0.000000,double pProfit=0.000000,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::BuyLimit(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::SellLimit(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::BuyStop(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::SellStop(string pSymbol,double pVolume,double pPrice,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::BuyStopLimit(string pSymbol,double pVolume,double pPrice,double pStopLimit,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CTradeExtended::SellStopLimit(string pSymbol,double pVolume,double pPrice,double pStopLimit,double pStop=0.000000,double pProfit=0.000000,datetime pExpiration=0,string pComment=NULL)
  {
   bool success = OpenPending(pSymbol,ORDER_TYPE_SELL_STOP_LIMIT,pVolume,pPrice,pStop,pProfit,pStopLimit,pExpiration,pComment);
   return(success);
  }
// Set magic number
void CTradeExtended::MagicNumber(ulong pMagic)
  {
   magicNumber = pMagic;
  }
// Set deviation
void CTradeExtended::Deviation(ulong pDeviation)
  {
   deviation = pDeviation;
  }
// Set fill type
void CTradeExtended::FillType(ENUM_ORDER_TYPE_FILLING pFill)
  {
   fillType = pFill;
  }
// Return code check
