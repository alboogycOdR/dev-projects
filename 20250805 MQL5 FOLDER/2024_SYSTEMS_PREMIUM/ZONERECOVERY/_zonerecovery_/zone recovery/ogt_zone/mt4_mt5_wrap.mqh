...
//|                                                                  |
//+------------------------------------------------------------------+
static double AccountFreeMarginCheck(string _symbol, int _cmd, double _volume)
  {
// Unimplemented stub
...

     {
      ...
      if((::Bars > 0) && (::Bars > prevBars))

        {
         ...
         for(int i = prevBars; i < ::Bars; i++)

           {
            ...
            int success = ::CopyRates(::Symbol(), PERIOD_CURRENT, i, 1, ratesArray);
...

        {
         ...
         int success = ::CopyRates(::Symbol(), PERIOD_CURRENT, 0, 1, ratesArray);
