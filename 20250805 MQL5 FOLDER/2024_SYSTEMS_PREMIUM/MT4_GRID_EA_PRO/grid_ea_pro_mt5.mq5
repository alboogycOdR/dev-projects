            ...
            if(LINEAR_METHOD)
              {
               ...
               //Print("LINEAR_METHOD BASED BUY:  "+GRID_BUY_PRICE);
              }
            if(VOLATILITY_DERIVED_METHOD)
              {
               //
               //               int STEP = MathMin(STEP_ORDERS,MAX_STEP);
               //
            ...
            if(LINEAR_METHOD)
              {
               ...
               //Print("LINEAR_METHOD BASED SELL:  "+GRID_SELL_PRICE);
            ...
            if(VOLATILITY_DERIVED_METHOD)
              {
               ...
               if(LOT_MULTIPLIER>1 && SELLS>0)
                  LOT = MathMin(LAST_SELL_LOT*LOT_MULTIPLIER,MAX_LOT);
               GRID_SELL_PRICE = NormalizeDouble(LAST_SELL_PRICE+STEP*_Point,Digits());
               //Print("ATR BASED SELL:  "+GRID_SELL_PRICE);
              }
