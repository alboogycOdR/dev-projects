...
//|                                                                  |
//| Project Details:                                                 |
//|   Project Name: ORB Enhanced                                     |
//|   Version: 0.3 (Gemini Build)                                    |
//|   Author: Your Name                                              |
//|   Date: June 10, 2024                                            |
//|                                                                  |
//| Version History:                                                 |
//|   - v0.1 (Base): Initial ORB logic with basic SL/TP.             |
//|   - v0.2 (Advanced): Added Breakeven, Trailing Stop, Day Filter. |
//|   - v0.3 (Gemini):                                               |
//|     - Added Custom Range & Asian Range strategy modes.           |
//|     - Added ATR-based dynamic stops.                             |
//|     - Added Volume and News filters.                             |
//|     - Refactored range calculation to use M1 data for accuracy.  |
//|     - Improved risk management with lot rounding.                |
//|     - Enhanced UI with input groups and comments.                |
//|     - Added chart objects for visual range representation.       |
//+------------------------------------------------------------------+
